...
app.intent('Game', (conv) => {
  conv.ask("Ok, lets play two truths one lie game. Haha, kidding, you are going to do most of the work. Its up to you who starts, each of you think of of three statements out of which one is wrong. Then say correct or incorrect when the other person responds.");
});
